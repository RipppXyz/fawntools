...
// ============================================================
// 2. IMAGE SEARCH (DUCKDUCKGO + REGEX - TANPA CHEERIO!)
// ============================================================
app.get('/api/imagesearch', async (req, res) => {
  ...
  try {
    // DuckDuckGo Image Search (dengan safe search aktif)
    ...
    // Regex untuk ambil semua URL gambar (jpg, jpeg, png, gif, webp)
    ...
    // Kalo hasilnya kosong, coba alternatif: ambil dari data-src
