...
app.use(express.static("public")); // opsional, kalo gak ada folder public diabaikan aja
...
app.get("/api/iqc", async (req, res) => {
  ...
  try {
    // Simulasi delay biar kaya hacker
      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          #result { margin-top: 30px; display: none; animation: fadeIn 0.5s ease; }
          @keyframes fadeIn {
          ...
          .loading { margin-top: 30px; display: none; text-align: center; }
          .loading .spinner {
            display: inline-block;
            width: 40px;
            height: 40px;
          ...
          .loading p { margin-top: 12px; opacity: 0.6; font-size: 14px; animation: blink 1s infinite; }
          @keyframes blink {
            0%, 100% { opacity: 0.6; }
            50% { opacity: 0.2; }
          }
          ...
          @media (max-width: 600px) {
            ...
            .input-group input { font-size: 14px; padding: 12px 16px; }
            .btn { font-size: 14px; padding: 12px 24px; width: 100%; }
      ...
      <body>
        ...
        <script>
          async function startIQC() {
            ...
            if (!target) { alert('Masukin target dulu bro!'); return; }
...
// Inisialisasi server lokal (tapi Vercel akan pake export)
